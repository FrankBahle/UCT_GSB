...
console.log(
    "\nGame Testing - GLA - Vercel function check\n" +
    "===========================================\n"
);
...
check(
    ...
    health.status === 200 &&
    JSON.parse(health.text).maximumTotal === 175,
...
const puzzle = gameOne.levels[0].puzzles[0];
...
check(
    ...
    usersBody.users[0].points.total === 5,
...
check(
    "The stored player keeps the per-question points",
    stored.games.day1.questions[puzzle.id].best === 5
);
